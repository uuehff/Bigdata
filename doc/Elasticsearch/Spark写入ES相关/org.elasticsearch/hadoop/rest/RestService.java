...
//                    MappingUtils.validateMapping(settings.getScrollFields(), mapping, validation, log);
    ...
    private static RestRepository initSingleIndex(Settings settings, int currentInstance, Resource resource, Log log) {
        ...
        if(settings.getProperty("es.bulk.shardid") != null){
//            System.out.print("es.bulk.shardid==============================");      //
//            log.info("es.bulk.shardid==============================");      //
            targetNode = targetShards.get(orderedShards.get(Integer.parseInt(settings.getProperty("es.bulk.shardid"))));
        }
