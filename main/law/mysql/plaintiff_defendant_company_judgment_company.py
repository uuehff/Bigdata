...
sql = 'select id,defendant_company from lawyer_picture where defendant_company is not null and defendant_company != "" and defendant_company like "%||%" '   #LOCATE函数，包含||,返回大于0的数值。
cursor.execute(sql)
