...
l = []
pipe.append("laws_doc:judgment_implement_all",'''"''')  # 往集合中添加元素
for row in row_2 :
    l.append(row[0])
s = ",".join(l)

pipe.append("laws_doc:judgment_implement_all",s)  # 往集合中添加元素
# pipe.append("laws_doc:judgment_administration_all",",")  # 往集合中添加元素
# pipe.incr("num")
pipe.append("laws_doc:judgment_implement_all",'''"''')  # 往集合中添加元素
