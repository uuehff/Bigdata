...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/law', table='(select * from law_rule_result2_add ) tmp',column='id',lowerBound=2880887,upperBound=2972024,numPartitions=30,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    def concat(x):
        ...
        for j in l2:
            l3.append(j[1])
        s = "<br/>".join(l3)         #法条之间换行
        return (s,l3[0])    #article,art,art为第一条内容
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave3:3306/law?useUnicode=true&characterEncoding=utf8', table='law_rule_result2_add_article',properties={"user": "weiwc", "password": "HHly2017."})
