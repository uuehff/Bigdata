...
======================================================================
-- select from_unixtime(946656000)
-- select SUBSTRING_INDEX(from_unixtime(40233600)," ",1)
-- 
-- select * from hht_lawyer_all_collect_match_result
-- where pra_number in (
-- SELECT pra_number from hht_lawyer_all_collect_match_result 
-- group by pra_number,name,org_name
-- having(count(*) > 1))
-- order by pra_number desc;
-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
-- 2）name：查询*，可以直接在查询结果中修改
-- SELECT * from hht_lawyer_all_collect_add where name REGEXP '[a-z0-9A-Z 	,:;-\\()!+@|"\'/]|\\?|\\]|\\[' 
-- or hex(name) REGEXP 'efbc8c|e38082|e38081|efbc9a|efbc9b|efbc9f|efbc81|e28098|e28099|efbc88|efbc89';
-- 
-- update hht_lawyer_all_collect_add set name = replace(name," ","");
-- update hht_lawyer_all_collect_add set name = replace(name,"・",".");
-- 
-- delete from hht_lawyer_all_collect_add where id < 44465 and 
-- (name REGEXP '[a-z0-9A-Z 	,:;-\\()!+@|"\'/]|\\?|\\]|\\[' 
-- or hex(name) REGEXP 'efbc8c|e38082|e38081|efbc9a|efbc9b|efbc9f|efbc81|e28098|e28099|efbc88|efbc89');
-- 
-- update hht_lawyer_all_collect_add set name = replace(name,"？","");
-- update hht_lawyer_all_collect_add set name = replace(name,"，","");
...
-- 3）org_name：
-- 
-- update hht_lawyer_all_collect_add set org_name = replace(org_name,"（","(");
-- update hht_lawyer_all_collect_add set org_name = replace(org_name,"）",")");
-- update hht_lawyer_all_collect_add set org_name = replace(org_name,"服务所","事务所");
-- 
-- delete from hht_lawyer_all_collect_add where pra_number = "" or CHAR_LENGTH(pra_number) < 8
-- 
-- 
-- 
-- select * from hht_lawyer_all_collect_match where pra_number = "14690200610392416"
-- select count(*) from hht_lawyer_all_collect_match where id >= 246055 and source is null;
-- update hht_lawyer_all_collect_match set source = "gov_v3" where id >= 246055 ;
-- 
-- select * from hht_lawyer_all_collect_add a join hht_lawyer_all_collect_match b 
-- on a.pra_number = b.pra_number and a.name = b.name and a.org_name = b.org_name 
-- order by a.id;
-- 
-- select * from hht_lawyer_all_collect_match_result
...
-- order by pra_number desc;
-- 
-- delete from hht_lawyer_all_collect_match_result where id = 253657;
-- delete from hht_lawyer_all_collect_match_result where id = 351248;
-- select * from hht_lawyer_all_collect_match_result where name = "王惠玲";
-- 
-- 202474	邹小湖	19609199310466991	江西药都律师事务所			1966-02-13			法律专业本科		男					13807950378				专职律师		赣司律证字第1993号					
-- 387772	邹小湖	19609199310466991	江西药都律师事务所							1993	男									专职律师						26	gov_v3
-- 202473	陈震	19210200710623617	甘肃陇凤律师事务所					庆阳市			男										甘肃省	C20066210210111					
-- 533785	陈震	19210200710623617	甘肃陇凤律师事务所							2007	男									专职律师						12	gov_v3
-- 202472	毕振昇	16590201720516642	新疆塔河律师事务所		第一师						男	652927198507115017				15292306771						A20106529271183					
-- 540463	毕振昇	16590201720516642	新疆塔河律师事务所							2017	男									兼职律师	新疆维吾尔自治区					2	gov_v3
-- 202471	孙安洛	16590201720270685	新疆卓鼎熙泰律师事务所								男																
-- 540419	孙安洛	16590201720270685	新疆卓鼎熙泰律师事务所							2017	男									兼职律师	新疆维吾尔自治区					2	gov_v3
-- 202470	朱万铭	16590201711995694	新疆塔河律师事务所		第一师						女	652901199112204825				18083967070						C20136590021090					
-- 540461	朱万铭	16590201711995694	新疆塔河律师事务所							2017	女									专职律师	新疆维吾尔自治区					2	gov_v3
=============================================================================
=============================================================================
=============================================================================
=============================================================================
