...
=========================================================================================
=========================================================================================
mysql> select type ,count(*) from uuid_type group by type order by count(*) desc ;
+-----------------------------------------------+----------+
| type                                          | count(*) |
+-----------------------------------------------+----------+
| 一审                                          |  2301572 |
...
alter table minshi_join  
modify uuid varchar(40),
modify type varchar(40),
add unique index uuid(uuid),
add index type(type);

alter table xinghshi_join  
modify uuid varchar(40),
modify type varchar(40),
add unique index uuid(uuid),
add index type(type);

alter table xinghzheng_join  
modify uuid varchar(40),
modify type varchar(40),
add unique index uuid(uuid),
add index type(type);

alter table zhixing_join  
modify uuid varchar(40),
modify type varchar(40),
add unique index uuid(uuid),
add index type(type);
