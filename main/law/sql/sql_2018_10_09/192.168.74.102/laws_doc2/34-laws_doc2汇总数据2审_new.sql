...
tmp_wxy:  id,uuid,type,judge_chief_new,doc_footer,doc_oriligation_new,court_idea_new,judge_result_new,history_new,history_new2,if_surrender,if_accumulate,if_nosuccess,if_guity,if_right,court_new,casedate_new,org_plaintiff,org_defendant,title,dispute,is_format_history_uuid

tmp_raolu: id,uuid,type,casedate,province,city,district,court_cate,court,new_office,new_lawyer
update judgment2_etl j, tmp_raolu t set 
...
tmp_hzj:  uuid,id,casedate,j_adult,crml_team,suspect_num,birth_day,age_year,party_info

update judgment2_etl j, tmp_hzj t set 
j.suspect_num = t.suspect_num,
j.birth_day = t.birth_day,
j.age_year = t.age_year,
j.crml_team = t.crml_team,
j.j_adult = t.j_adult,
j.party_info = t.party_info where j.uuid = t.uuid ; 

uuid_and_lawlist_ids_2shen_result:  lawlist_ids

update judgment2_etl j, uuid_and_lawlist_ids_2shen_result t set 
...
create table judgment2_etl as 
SELECT a.*,province,city,district,court_cate,court,new_office,new_lawyer,j_adult,crml_team,suspect_num,birth_day,age_year,party_info 
from tmp_wxy a, uuid_and_lawlist_ids_2shen_result b,tmp_raolu d,tmp_hzj e where 1=2

INSERT into judgment2_etl(id,uuid,type,judge_chief_new,doc_footer,doc_oriligation_new,court_idea_new,judge_result_new,history_new,history_new2,if_surrender,if_accumulate,if_nosuccess,if_guity,if_right,court_new,casedate_new,org_plaintiff,org_defendant,title,dispute,is_format_history_uuid
) SELECT id,uuid,type,judge_chief_new,doc_footer,doc_oriligation_new,court_idea_new,judge_result_new,history_new,history_new2,if_surrender,if_accumulate,if_nosuccess,if_guity,if_right,court_new,casedate_new,org_plaintiff,org_defendant,title,dispute,is_format_history_uuid
 from tmp_wxy
