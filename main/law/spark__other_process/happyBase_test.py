...
print UUID.uuid3(UUID.NAMESPACE_DNS,"10000")
...
#     # print type(v),v
#
#     sorted_key_list = sorted(v)
#     sorted_dict = map(lambda x: {x: v[x]}, sorted_key_list)
#     print(sorted_dict)
#     print json.dumps(sorted_dict).replace("}, {",",").replace("[{","{").replace("}]","}")
#     print type(json.loads(json.dumps(sorted_dict).replace("}, {",",").replace("[{","{").replace("}]","}").replace("d:","")))
#     s =  json.loads(json.dumps(sorted_dict).replace("}, {",",").replace("[{","{").replace("}]","}").replace("d:",""))
#
#
#     # print (sorted(v.items(), key=lambda item: item[0]))
#     print s
#     for i in s:
#         # print i[0].replace("d:",""),i[1]
#         print i,s[i]
#     print "============================================="
#     d +=1
# print d
...
# t.put('002',data={'d:id': '12345'})
# t.put('003',data={'d:id': '12345'})
# t.put('004',data={'d:id': '12345'})
# t.put('005',data={'d:id': '12345'})
# t.put('006',data={'d:id': '中华'})
# t.put('007',data={'d:id': u'中华'})
# q = t.scan()
...
# q = t.scan(row_start="0_2014-13",filter="QualifierFilter(=, 'binary:uuid') AND KeyOnlyFilter()")
