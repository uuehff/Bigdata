...
try:
    ...
    for k, v in q:
        ...
        # for k1 in v.keys():
            # data.update({k1:v[k1]})
        sql2 = " insert into judgment_all_50w (id,uuid,party_info,trial_process,trial_request,court_find,court_idea,judge_result,doc_footer,caseid,title,court,court_uid,lawlist,law_id,casedate,reason_type,type,judge_type,reason,reason_uid,province,plt_claim,dft_rep,crs_exm) " \
