...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_adjudication',
                               table='(select id,uuid,court,court_idea,judge_result,doc_footer,judge_type from adjudication_civil_etl_v2  ) tmp',
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_adjudication?useUnicode=true&characterEncoding=utf8', table='adjudication_civil_etl_v2_court_cate_judge_footer',properties={"user": "weiwc", "password": "HHly2017."})
