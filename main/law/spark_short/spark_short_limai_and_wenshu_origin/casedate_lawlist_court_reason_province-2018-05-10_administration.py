...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_administration',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from administration_etl  ) tmp',
                               column='id', lowerBound=1, upperBound=550541, numPartitions=108,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_administration?useUnicode=true&characterEncoding=utf8', table='administration_other_fields',properties={"user": "weiwc", "password": "HHly2017."})
