...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_zhangye_etl', table='(select id,uuid,lawlist from judgment_zhangye_other_fields ) tmp2',column='id',lowerBound=1,upperBound=4711424,numPartitions=88,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_zhangye_etl?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_uuid_law_id',properties={"user": "weiwc", "password": "HHly2017."})
