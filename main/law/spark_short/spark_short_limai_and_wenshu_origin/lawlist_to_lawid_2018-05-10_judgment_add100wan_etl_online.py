...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add100wan', table='(select id,uuid,lawlist from judgment_add100wan_etl ) tmp2',column='id',lowerBound=2824917,upperBound=3861713,numPartitions=60,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add100wan?useUnicode=true&characterEncoding=utf8', table='judgment_add100wan_uuid_law_id',properties={"user": "weiwc", "password": "HHly2017."})
