...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_adjudication', table='(select id,uuid_,lawlist from adjudication_xingshi_etl_v2 ) tmp2',column='id',lowerBound=1,upperBound=3879070,numPartitions=69,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_adjudication?useUnicode=true&characterEncoding=utf8', table='adjudication_xingshi_uuid_law_id_v2',properties={"user": "weiwc", "password": "HHly2017."})
