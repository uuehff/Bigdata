...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_zhangye_etl',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer,court_idea from judgment_zhangye_join_all  ) tmp',
                               column='id', lowerBound=1, upperBound=4711424, numPartitions=100,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_zhangye_etl?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_other_fields',properties={"user": "weiwc", "password": "HHly2017."})
