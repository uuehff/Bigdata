...
if __name__ == "__main__":
    ...
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_new', table='(select id,uuid,party_info,court_idea,judge_type from judgment_new_v2  ) tmp2',column='id',lowerBound=1,upperBound=6003071,numPartitions=79,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_new?useUnicode=true&characterEncoding=utf8', table='judgment_new_v2_lawyer_id',properties={"user": "weiwc", "password": "HHly2017."})
