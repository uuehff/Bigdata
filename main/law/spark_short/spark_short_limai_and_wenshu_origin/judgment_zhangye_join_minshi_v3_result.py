...
if __name__ == "__main__":
    ...
    df1 = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2',
                               table='(select id,uuid,title,reason_type,caseid,type,casedate from judgment_zhangye_civil_v3  ) tmp',
                               column='id', lowerBound=1, upperBound=1865053, numPartitions=40,
                               properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_civil_v3_result',properties={"user": "weiwc", "password": "HHly2017."})
