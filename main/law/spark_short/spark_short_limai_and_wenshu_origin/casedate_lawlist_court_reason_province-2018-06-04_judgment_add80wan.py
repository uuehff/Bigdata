...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add80wan',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from judgment_add80wan_etl01  ) tmp',
                               column='id', lowerBound=14089359, upperBound=15785377, numPartitions=108,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add80wan?useUnicode=true&characterEncoding=utf8', table='judgment_add80wan_other_fields',properties={"user": "weiwc", "password": "HHly2017."})
