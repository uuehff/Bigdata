...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_adjudication',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from adjudication_xingshi_etl  ) tmp',
                               column='id', lowerBound=3030300, upperBound=3392980, numPartitions=30,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_adjudication?useUnicode=true&characterEncoding=utf8', table='adjudication_xingshi_other_fields',properties={"user": "weiwc", "password": "HHly2017."})
