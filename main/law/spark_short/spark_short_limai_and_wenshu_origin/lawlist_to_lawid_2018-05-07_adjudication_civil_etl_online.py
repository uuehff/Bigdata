...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_adjudication', table='(select id,uuid,lawlist from adjudication_civil_etl ) tmp2',column='id',lowerBound=1,upperBound=3879070,numPartitions=60,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_adjudication?useUnicode=true&characterEncoding=utf8', table='adjudication_civil_uuid_law_id',properties={"user": "weiwc", "password": "HHly2017."})
