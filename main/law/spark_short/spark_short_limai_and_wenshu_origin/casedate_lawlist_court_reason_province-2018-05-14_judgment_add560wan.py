...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add560wan',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from judgment_add560wan_all  ) tmp',
                               column='id', lowerBound=3, upperBound=12307680, numPartitions=108,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add560wan?useUnicode=true&characterEncoding=utf8', table='judgment_add560wan_other_fields',properties={"user": "weiwc", "password": "HHly2017."})
