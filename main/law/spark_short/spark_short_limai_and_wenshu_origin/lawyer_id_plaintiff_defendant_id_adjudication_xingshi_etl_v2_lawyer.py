...
if __name__ == "__main__":
    ...
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_adjudication', table='(select id,plaintiff_info,defendant_info,uuid from adjudication_xingshi_etl_v2_lawyer ) tmp2',column='id',lowerBound=3030306,upperBound=3392972,numPartitions=49,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_adjudication?useUnicode=true&characterEncoding=utf8', table='adjudication_xingshi_etl_v2_lawyer_id',properties={"user": "weiwc", "password": "HHly2017."})
