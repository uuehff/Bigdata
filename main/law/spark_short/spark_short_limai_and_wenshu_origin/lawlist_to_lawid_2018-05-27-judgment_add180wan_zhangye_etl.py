...
if __name__ == "__main__":
    ...
    lawlist_id = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_v2', table='(select id,title_short,art_num,lawlist_id from law_rule_result2) tmp',column='id',lowerBound=1,upperBound=2881160,numPartitions=20,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_zhangye_etl2', table='(select id,uuid,lawlist from judgment_zhangye_180wan_other_fields ) tmp2',column='id',lowerBound=4816522,upperBound=6530232,numPartitions=88,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_zhangye_etl2?useUnicode=true&characterEncoding=utf8', table='judgment_add180wan_zhangye_uuid_law_id',properties={"user": "weiwc", "password": "HHly2017."})
