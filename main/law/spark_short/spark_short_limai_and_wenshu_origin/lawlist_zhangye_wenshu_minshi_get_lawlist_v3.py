...
if __name__ == "__main__":
    ...
    lawlist_id = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/law',
                                      ...
                                      column='id', lowerBound=1, upperBound=2881160, numPartitions=60,
    ...
    lawlist = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2',
                               table='(select id,uuid_,court_idea from judgment_zhangye_civil_v3_result ) tmp',
                               column='id', lowerBound=1, upperBound=1865053, numPartitions=39,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='uuid_law_id_zhangye_civil_v3',properties={"user": "weiwc", "password": "HHly2017."})
