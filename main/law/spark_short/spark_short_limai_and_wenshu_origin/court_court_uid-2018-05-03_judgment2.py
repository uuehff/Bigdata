...
if __name__ == "__main__":
    ...
    # judgment_new：556万
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc2',
                               table='(select id,uuid,court from judgment2_main_etl ) tmp',
                               column='id', lowerBound=1, upperBound=41000, numPartitions=1,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc2?useUnicode=true&characterEncoding=utf8', table='court_uid',properties={"user": "root", "password": "root"})
