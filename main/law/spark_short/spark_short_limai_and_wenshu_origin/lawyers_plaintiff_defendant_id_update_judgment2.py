...
if __name__ == "__main__":
    ...
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc2', table='(select id,plaintiff_id,defendant_id from judgment2_main_etl ) tmp2',column='id',lowerBound=1,upperBound=800000,numPartitions=10,properties={"user": "root", "password": "root"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc2?useUnicode=true&characterEncoding=utf8', table='plain_defen_id2',properties={"user": "root", "password": "root"})
