...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add300wan',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from judgment_add300wan_all  ) tmp',
                               column='id', lowerBound=12307681, upperBound=16437623, numPartitions=108,
    ...
    def get_result(x):
        if x[1][1] is None:
            return (x[0], x[1][0][0], x[1][0][1], x[1][0][2], x[1][0][3], x[1][0][4], x[1][0][5], "", "")
        else:
            return (x[0], x[1][0][0], x[1][0][1], x[1][0][2], x[1][0][3], x[1][0][4], x[1][0][5], x[1][1][0], x[1][1][1])
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add300wan?useUnicode=true&characterEncoding=utf8', table='judgment_add300wan_other_fields',properties={"user": "weiwc", "password": "HHly2017."})
