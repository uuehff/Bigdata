...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from civil_etl_v2_800w_02  ) tmp',
                               column='id', lowerBound=8000000, upperBound=16437624, numPartitions=97,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil?useUnicode=true&characterEncoding=utf8', table='civil_other_fields_v2_800w_02',properties={"user": "weiwc", "password": "HHly2017."})
