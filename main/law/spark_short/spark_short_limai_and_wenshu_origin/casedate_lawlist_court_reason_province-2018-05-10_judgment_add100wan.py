...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add100wan',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from judgment_add100wan_etl  ) tmp',
                               column='id', lowerBound=2824917, upperBound=3861713, numPartitions=108,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add100wan?useUnicode=true&characterEncoding=utf8', table='judgment_add100wan_other_fields',properties={"user": "weiwc", "password": "HHly2017."})
