...
if __name__ == "__main__":
    ...
    lawlist_id = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave1:3306/laws_doc_v3', table='(select id,title_short,art_num,lawlist_id from law_rule_result2) tmp',column='id',lowerBound=1,upperBound=2881160,numPartitions=30,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_judgment', table='(select id,uuid,lawlist from judgment_etl_v2 ) tmp2',column='id',lowerBound=1,upperBound=3861714,numPartitions=69,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_judgment?useUnicode=true&characterEncoding=utf8', table='judgment_uuid_law_id_v2',properties={"user": "weiwc", "password": "HHly2017."})
