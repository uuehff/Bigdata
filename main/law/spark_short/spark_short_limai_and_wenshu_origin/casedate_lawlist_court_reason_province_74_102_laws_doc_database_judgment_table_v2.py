...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_judgment',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from judgment_etl_v2  ) tmp',
                               column='id', lowerBound=1, upperBound=3861714, numPartitions=97,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_judgment?useUnicode=true&characterEncoding=utf8', table='judgment_other_fields_v2',properties={"user": "weiwc", "password": "HHly2017."})
