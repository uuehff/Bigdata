...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_adjudication',
                               table='(select id,uuid,court,court_idea,judge_result,doc_footer,judge_type from adjudication_xingshi_etl_v2  ) tmp',
                               column='id', lowerBound=1, upperBound=3569377, numPartitions=97,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_adjudication?useUnicode=true&characterEncoding=utf8', table='adjudication_xingshi_etl_v2_court_cate_judge_footer',properties={"user": "weiwc", "password": "HHly2017."})
