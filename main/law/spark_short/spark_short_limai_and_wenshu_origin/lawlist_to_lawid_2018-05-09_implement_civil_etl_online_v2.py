...
if __name__ == "__main__":
    ...
    lawlist_id = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/law', table='(select id,title_short,art_num,lawlist_id from law_rule_result2) tmp',column='id',lowerBound=1,upperBound=2881160,numPartitions=49,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_implement', table='(select id,uuid_,lawlist from implement_civil_etl_v2 ) tmp2',column='id',lowerBound=1,upperBound=2119611,numPartitions=50,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_implement?useUnicode=true&characterEncoding=utf8', table='implement_uuid_law_id_v2',properties={"user": "weiwc", "password": "HHly2017."})
