...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_imp_other',
                               table='(select id,uuid,court,court_idea,judge_result,doc_footer,judge_type from imp_other_etl_v2  ) tmp',
                               column='id', lowerBound=1, upperBound=4529439, numPartitions=98,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_imp_other?useUnicode=true&characterEncoding=utf8', table='imp_other_etl_v2_court_cate_judge_footer',properties={"user": "weiwc", "password": "HHly2017."})
