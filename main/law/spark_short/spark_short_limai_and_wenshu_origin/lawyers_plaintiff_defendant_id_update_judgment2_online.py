...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_v2', table='(select id,old_id from lawyers_new) tmp',column='id',lowerBound=1,upperBound=2800000,numPartitions=10,properties={"user": "root", "password": "HHly2017."})
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_v2', table='(select id,plaintiff_id,defendant_id from judgment2_main_etl ) tmp2',column='id',lowerBound=1,upperBound=800000,numPartitions=10,properties={"user": "root", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_v2?useUnicode=true&characterEncoding=utf8', table='plain_defen_id_judgment2',properties={"user": "root", "password": "HHly2017."})
