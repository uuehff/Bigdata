...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_adjudication',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from adjudication_civil_etl  ) tmp',
                               column='id', lowerBound=1, upperBound=3879070, numPartitions=100,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_adjudication?useUnicode=true&characterEncoding=utf8', table='adjudication_civil_other_fields',properties={"user": "weiwc", "password": "HHly2017."})
