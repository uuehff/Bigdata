...
if __name__ == "__main__":
    ...
    # df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2', table='(select id,uuid,party_info,court_idea,judge_type from judgment_zhangye_xingshi_v2_result  ) tmp2',column='id',lowerBound=1,upperBound=7647111,numPartitions=79,properties={"user": "weiwc", "password": "HHly2017."})
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2', table='(select id,uuid,party_info,court_idea,judge_type from judgment_zhangye_xingshi_v3_result  ) tmp2',column='id',lowerBound=1,upperBound=8606165,numPartitions=79,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_xingshi_v2_v3_result_lawyer_id',properties={"user": "weiwc", "password": "HHly2017."})
