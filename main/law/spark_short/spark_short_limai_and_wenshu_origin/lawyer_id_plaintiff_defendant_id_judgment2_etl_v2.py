...
if __name__ == "__main__":
    ...
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_judgment', table='(select id,uuid,party_info,court_idea,judge_type from judgment2_etl_v2  ) tmp2',column='id',lowerBound=1,upperBound=50000,numPartitions=5,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_judgment?useUnicode=true&characterEncoding=utf8', table='judgment2_etl_v2_lawyer_id',properties={"user": "weiwc", "password": "HHly2017."})
