...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add80wan', table='(select id,uuid,lawlist from judgment_add80wan_etl01 ) tmp2',column='id',lowerBound=14089359,upperBound=15785377,numPartitions=60,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add80wan?useUnicode=true&characterEncoding=utf8', table='judgment_add80wan_uuid_law_id',properties={"user": "weiwc", "password": "HHly2017."})
