...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_implement', table='(select id,uuid,lawlist from implement_civil_etl ) tmp2',column='id',lowerBound=1,upperBound=2076031,numPartitions=100,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_implement?useUnicode=true&characterEncoding=utf8', table='implement_uuid_law_id',properties={"user": "weiwc", "password": "HHly2017."})
