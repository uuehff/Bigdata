...
if __name__ == "__main__":
    ...
    def get_doc_footer_one_line(doc_footer):
        ...
        doc_footer_result = "\n".join(l).replace(u"代理审判长", u" 代理审判长 ").replace(u"审判长", u" 审判长  ").replace(u"代理审判员",
                                                                                                          u" 代理审判员") \
            .replace(u"人民审判员", u" 人民审判员").replace(u"助理审判员", u" 助理审判员").replace(u"审判员", u" 审判员  ").replace(u"书记员",
                                                                                                          u" 书记员  ") \
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_administration',
                               table='(select id,uuid,court,court_idea,judge_result,doc_footer,judge_type from administration_etl_v2  ) tmp',
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_administration?useUnicode=true&characterEncoding=utf8', table='administration_etl_v2_judge_footer',properties={"user": "weiwc", "password": "HHly2017."})
