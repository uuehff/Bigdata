...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil', table='(select id,uuid_,lawlist from civil_etl_v2_800w_02 ) tmp2',column='id',lowerBound=8000000,upperBound=16437624,numPartitions=69,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil?useUnicode=true&characterEncoding=utf8', table='uuid_law_id_civil_etl_v2_800w_01',properties={"user": "weiwc", "password": "HHly2017."})
