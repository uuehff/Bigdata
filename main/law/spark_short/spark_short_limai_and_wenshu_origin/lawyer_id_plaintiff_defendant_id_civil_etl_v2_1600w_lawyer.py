...
if __name__ == "__main__":
    ...
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil', table='(select id,plaintiff_info,defendant_info,uuid from civil_etl_v2_1600w_lawyer ) tmp2',column='id',lowerBound=1,upperBound=6330428,numPartitions=79,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil?useUnicode=true&characterEncoding=utf8', table='civil_etl_v2_1600w_lawyer_id',properties={"user": "weiwc", "password": "HHly2017."})
