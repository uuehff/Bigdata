...
if __name__ == "__main__":
    ...
    def flat_uid(uid):
        ...
        return reason_uid
    def get_reason(x):
        # id, uuid, court, title, doc_footer
        # (x[1], x[3], x[4], x[5], x[6])
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_administration',
                               table='(select id,uuid,court,title,trial_process,trial_request,court_find,doc_footer from administration_etl_v2  ) tmp',
                               column='id', lowerBound=1, upperBound=550541, numPartitions=97,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_administration?useUnicode=true&characterEncoding=utf8', table='administration_other_fields_v2',properties={"user": "weiwc", "password": "HHly2017."})
