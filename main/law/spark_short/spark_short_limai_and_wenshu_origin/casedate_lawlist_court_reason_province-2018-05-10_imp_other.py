...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_imp_other',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from imp_other_etl  ) tmp',
                               column='id', lowerBound=1, upperBound=4733848, numPartitions=108,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_imp_other?useUnicode=true&characterEncoding=utf8', table='imp_other_other_fields',properties={"user": "weiwc", "password": "HHly2017."})
