...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_zhangye_etl2',
                               table='(select * from judgment_zhangye_add180wan_etl01 where id > 4816521 ) tmp',
                               column='id', lowerBound=4816522, upperBound=6530232, numPartitions=52,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_zhangye_etl2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_180wan_join_all',properties={"user": "weiwc", "password": "HHly2017."})
