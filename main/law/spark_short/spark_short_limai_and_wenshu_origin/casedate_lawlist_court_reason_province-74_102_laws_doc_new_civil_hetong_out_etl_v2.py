...
if __name__ == "__main__":
    ...
    def get_reason(x):
        ...
        return (x[1],("||".join(list(set(name))),reason_uids))


    # judgment_new：556万,3030306	3392975
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_new',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find from judgment_new_v2  ) tmp',
                               column='id', lowerBound=1, upperBound=6003507, numPartitions=97,
    ...
    def get_result(x):
        if x[1][1] is None:
            ...
            return (x[0], x[1][0][0], x[1][0][1], x[1][1][0], x[1][1][1])
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_new?useUnicode=true&characterEncoding=utf8', table='judgment_new_other_fields_v2',properties={"user": "weiwc", "password": "HHly2017."})
