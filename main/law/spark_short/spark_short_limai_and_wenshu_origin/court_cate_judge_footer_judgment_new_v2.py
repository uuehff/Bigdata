...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_new',
                               table='(select id,uuid,court,court_idea,judge_result,doc_footer,judge_type from judgment_new_v2  ) tmp',
                               column='id', lowerBound=1, upperBound=6003071, numPartitions=98,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_new?useUnicode=true&characterEncoding=utf8', table='judgment_new_v2_court_cate_judge_footer',properties={"user": "weiwc", "password": "HHly2017."})
