...
if __name__ == "__main__":
    ...
    lawlist_id = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_v2', table='(select id,title_short,art_num,lawlist_id from law_rule_result2) tmp',column='id',lowerBound=1,upperBound=2881160,numPartitions=30,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add300wan', table='(select id,uuid,lawlist from judgment_add300wan_all ) tmp2',column='id',lowerBound=12307681,upperBound=16437623,numPartitions=60,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add300wan?useUnicode=true&characterEncoding=utf8', table='judgment_add300wan_uuid_law_id',properties={"user": "weiwc", "password": "HHly2017."})
