...
if __name__ == "__main__":
    ...
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2', table='(select id,uuid,party_info,court_idea,judge_type from judgment_zhangye_zhixing_v4_result  ) tmp2',column='id',lowerBound=846540, upperBound=3777932,numPartitions=79,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_zhixing_v4_result_lawyer_id',properties={"user": "weiwc", "password": "HHly2017."})
