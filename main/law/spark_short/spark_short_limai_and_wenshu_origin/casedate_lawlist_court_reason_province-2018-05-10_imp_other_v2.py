...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_imp_other',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from imp_other_etl_v2  ) tmp',
                               column='id', lowerBound=1, upperBound=4733897, numPartitions=97,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_imp_other?useUnicode=true&characterEncoding=utf8', table='imp_other_other_fields_v2',properties={"user": "weiwc", "password": "HHly2017."})
