...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_administration', table='(select id,uuid,lawlist from administration_etl ) tmp2',column='id',lowerBound=1,upperBound=550541,numPartitions=108,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_administration?useUnicode=true&characterEncoding=utf8', table='administration_uuid_law_id',properties={"user": "weiwc", "password": "HHly2017."})
