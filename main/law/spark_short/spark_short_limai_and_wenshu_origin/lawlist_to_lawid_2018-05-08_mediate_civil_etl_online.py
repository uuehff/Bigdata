...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_mediate', table='(select id,uuid,lawlist from mediate_civil_etl ) tmp2',column='id',lowerBound=25,upperBound=131607,numPartitions=30,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_mediate?useUnicode=true&characterEncoding=utf8', table='mediate_civil_uuid_law_id',properties={"user": "weiwc", "password": "HHly2017."})
