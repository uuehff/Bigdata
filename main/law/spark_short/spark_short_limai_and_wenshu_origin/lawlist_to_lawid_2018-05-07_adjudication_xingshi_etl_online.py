...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_adjudication', table='(select id,uuid,lawlist from adjudication_xingshi_etl ) tmp2',column='id',lowerBound=3030300,upperBound=3392980,numPartitions=30,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_adjudication?useUnicode=true&characterEncoding=utf8', table='adjudication_xingshi_uuid_law_id',properties={"user": "weiwc", "password": "HHly2017."})
