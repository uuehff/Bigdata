...
if __name__ == "__main__":
    ...
    lawlist_id = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil', table='(select * from uuid_law_id_civil_etl_v2_800w_02) tmp',column='id',lowerBound=1,upperBound=5420192,numPartitions=69,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    uuid_uuid= sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil', table='(select id,uuid,uuid_ from civil_etl_v2_800w_02 ) tmp2',column='id',lowerBound=1,upperBound=8000000,numPartitions=30,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    result = a.join(b).map(lambda x:x[1]).map(lambda x:(x[1][0],x[0],x[1][2]))
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil?useUnicode=true&characterEncoding=utf8', table='uuid_law_id_civil_etl_v2_800w_02_result',properties={"user": "weiwc", "password": "HHly2017."})
