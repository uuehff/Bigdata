...
if __name__ == "__main__":
    ...
    lawlist_id = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil', table='(select * from uuid_law_id_civil_etl_v2_800w_01) tmp',column='id',lowerBound=1,upperBound=7414180,numPartitions=69,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil?useUnicode=true&characterEncoding=utf8', table='uuid_law_id_civil_etl_v2_800w_01_result',properties={"user": "weiwc", "password": "HHly2017."})
