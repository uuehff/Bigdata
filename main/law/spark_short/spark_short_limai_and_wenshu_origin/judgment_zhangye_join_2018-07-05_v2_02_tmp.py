...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2',
                               table='(select id,uuid from judgment_zhangye_400w_v3_03 ) tmp',
                               column='id', lowerBound=1, upperBound=8450135, numPartitions=25,
                               properties={"user": "weiwc", "password": "HHly2017."})

    df1 = sqlContext.read.jdbc(url='jdbc:mysql://192.168.74.113:3306/wenshu_gov',
                               table='(select id,uuid,case_name,case_type,case_number,jud_pro,jud_date from judgment_doc  ) tmp',
                               column='id', lowerBound=1, upperBound=28288219, numPartitions=74,
                               properties={"user": "root", "password": "hhly419"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_civil_v3',properties={"user": "weiwc", "password": "HHly2017."})

    f = sqlContext.createDataFrame(lawyer_k_v_xingshi, schema=schema)
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_xingshi_v3',properties={"user": "weiwc", "password": "HHly2017."})

    f = sqlContext.createDataFrame(lawyer_k_v_xingzheng, schema=schema)
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_xingzheng_v3',properties={"user": "weiwc", "password": "HHly2017."})

    f = sqlContext.createDataFrame(lawyer_k_v_zhixing, schema=schema)
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_zhixing_v3',properties={"user": "weiwc", "password": "HHly2017."})
