...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_implement',
                               table='(select id,uuid,court,title,trial_request,trial_process,court_find,doc_footer from implement_civil_etl_v2  ) tmp',
                               column='id', lowerBound=1, upperBound=2119611, numPartitions=97,
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_implement?useUnicode=true&characterEncoding=utf8', table='implement_other_fields_v2',properties={"user": "weiwc", "password": "HHly2017."})
