...
if __name__ == "__main__":
    ...
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_judgment', table='(select id,uuid,party_info,court_idea,judge_type from judgment_etl_v2  ) tmp2',column='id',lowerBound=1,upperBound=3791089,numPartitions=79,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_judgment?useUnicode=true&characterEncoding=utf8', table='judgment_etl_v2_lawyer_id',properties={"user": "weiwc", "password": "HHly2017."})
