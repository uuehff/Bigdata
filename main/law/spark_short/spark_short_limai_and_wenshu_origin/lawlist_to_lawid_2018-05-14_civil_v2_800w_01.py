...
if __name__ == "__main__":
    ...
    lawlist= sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil', table='(select id,uuid_,lawlist from civil_etl_v2_800w_01 ) tmp2',column='id',lowerBound=1,upperBound=8000000,numPartitions=69,properties={"user": "weiwc", "password": "HHly2017."})
