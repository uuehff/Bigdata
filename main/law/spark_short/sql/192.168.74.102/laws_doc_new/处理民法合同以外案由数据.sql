...
v2====================================
create table judgment_new_v2 like laws_doc_adjudication.adjudication_civil_etl_v2;
create table judgment_new_v3 like laws_doc_adjudication.adjudication_civil_etl_v2;
create table judgment_new_v2_01 like laws_doc_adjudication.adjudication_civil_etl_v2;
create table judgment_new_v2_02 like laws_doc_adjudication.adjudication_civil_etl_v2;
create table judgment_new_v2_03 like laws_doc_adjudication.adjudication_civil_etl_v2;


create table judgment_new_v2_01 as select * from 


create table judgment_new_other_fields_v2 like laws_doc_implement.implement_other_fields_v2;

create table judgment_new_other_fields_v2_result like judgment_new_other_fields_v2
create table judgment_new_uuid_law_id_v2_result like judgment_new_uuid_law_id_v2
