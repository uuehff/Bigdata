...
if __name__ == "__main__":
    ...
    lawlist_id = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave3:3306/law',
                                      ...
                                      column='id', lowerBound=1, upperBound=2881160, numPartitions=49,
    ...
    lawlist = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2',
                               table='(select id,uuid,court_idea from judgment_zhangye_zhixing_v5_result ) tmp',
                               column='id', lowerBound=14241, upperBound=19850871, numPartitions=50,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='uuid_law_id_zhangye_zhixing_v5',properties={"user": "weiwc", "password": "HHly2017."})
