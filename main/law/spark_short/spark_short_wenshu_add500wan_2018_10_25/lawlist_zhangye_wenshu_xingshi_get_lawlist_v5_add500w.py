...
if __name__ == "__main__":
    ...
    lawlist = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2',
                               table='(select id,uuid,court_idea from judgment_zhangye_xingshi_v5_result ) tmp',
                               column='id', lowerBound=182, upperBound=19850891, numPartitions=30,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='uuid_law_id_zhangye_xingshi_v5',properties={"user": "weiwc", "password": "HHly2017."})
