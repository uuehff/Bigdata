...
if __name__ == "__main__":
    ...
    lawlist = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2',
                               table='(select id,uuid,court_idea from judgment_zhangye_zhixing_v4_result ) tmp',
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='uuid_law_id_zhangye_zhixing_v4',properties={"user": "weiwc", "password": "HHly2017."})
