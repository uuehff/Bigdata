...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2',
                               table='(select id,uuid,court,court_idea,judge_result,doc_footer,judge_type from judgment_zhangye_civil_v4_result  ) tmp',
    ...
    # print str(f.count()) + "======================"
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_civil_v4_result_court_cate_judge_footer',properties={"user": "weiwc", "password": "HHly2017."})
