...
if __name__ == "__main__":
    ...
    # hbase_table = 'laws_doc:judgment_civil_all'
    ...
    # f.write.jdbc(url='jdbc:mysql://192.168.74.113:3306/wenshu_gov?useUnicode=true&characterEncoding=utf8', table='hbase_uuid_old_zhixing',properties={"user": "root", "password": "hhly419"})
