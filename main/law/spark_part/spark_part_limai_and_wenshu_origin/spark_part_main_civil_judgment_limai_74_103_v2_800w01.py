...
if __name__ == "__main__":
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave3:3306/laws_doc_civil?useUnicode=true&characterEncoding=utf8', table='civil_etl_v2_800w_01',properties={"user": "weiwc", "password": "HHly2017."})
