...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.10.22:3306/laws_doc', table='(select id,uuid,doc_content from administration ) tmp',column='id',lowerBound=1,upperBound=550542,numPartitions=24,properties={"user": "tzp", "password": "123456"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_administration?useUnicode=true&characterEncoding=utf8', table='administration_etl',properties={"user": "weiwc", "password": "HHly2017."})
