...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://10.41.104.5:3306/laws_doc', table='(select id,uuid,doc_content from judgment where id > 5000000 and id <= 6000000 ) tmp',column='id',lowerBound=5000000,upperBound=6000000,numPartitions=24,properties={"user": "root", "password": "Hhly@2018"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_zhangye_update1?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_etl07',properties={"user": "root", "password": "root"})
    sc.stop()
