...
if __name__ == "__main__":
    ...
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc', table='(select id,uuid,law_id from judgment_main_etl ) tmp2',column='id',lowerBound=0,upperBound=2800000,numPartitions=10,properties={"user": "root", "password": "root"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc?useUnicode=true&characterEncoding=utf8', table='tmp_lawlist_id',properties={"user": "root", "password": "root"})
