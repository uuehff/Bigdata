...
if __name__ == "__main__":
    ...
    id_lawyer = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc', table='id_lawyer',column='id',lowerBound=0,upperBound=80000,numPartitions=3,properties={"user": "root", "password": "root"})
    tmp_lawyers = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc', table='(select id,uuid,plaintiff_info,defendant_info from tmp_lawyers ) tmp',column='id',lowerBound=0,upperBound=50000,numPartitions=12,properties={"user": "root", "password": "root"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc?useUnicode=true&characterEncoding=utf8', table='party_info_result_ids',properties={"user": "root", "password": "root"})
