...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.12.35:3306/civil', table="(select id,uuid,doc_content,judge_type from judgment where id > 10500000 and id <= 11295127 ) tmp ",column='id',lowerBound=10500000,upperBound=11295127,numPartitions=24,properties={"user": "root", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave2:3306/laws_doc_judgment_add560wan?useUnicode=true&characterEncoding=utf8', table='judgment_add560wan_etl08',properties={"user": "root", "password": "HHly2017."})
