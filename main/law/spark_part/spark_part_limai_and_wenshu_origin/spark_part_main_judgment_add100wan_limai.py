...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.12.34:3306/laws_doc', table='(select id,uuid,doc_content from judgment where id > 2824916 ) tmp',column='id',lowerBound=2824916,upperBound=3861714,numPartitions=24,properties={"user": "tzp", "password": "123456"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_judgment_add100wan?useUnicode=true&characterEncoding=utf8', table='judgment_add100wan_etl',properties={"user": "root", "password": "root"})
