...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.12.35:3306/civil', table="(select id,uuid,doc_content from judgment where id > 15300000 and id <= 16437624 and is_crawl = '1' ) tmp ",column='id',lowerBound=15300000,upperBound=16437624,numPartitions=24,properties={"user": "root", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave2:3306/laws_doc_judgment_add300wan?useUnicode=true&characterEncoding=utf8', table='judgment_add300wan_etl04',properties={"user": "root", "password": "HHly2017."})
