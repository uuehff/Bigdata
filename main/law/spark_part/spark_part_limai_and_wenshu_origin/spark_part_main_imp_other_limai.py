...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.10.22:3306/laws_doc', table='(select id,uuid,doc_content from imp_other where id > 3000000 ) tmp',column='id',lowerBound=3000000,upperBound=4733897,numPartitions=24,properties={"user": "tzp", "password": "123456"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_imp_other?useUnicode=true&characterEncoding=utf8', table='imp_other_etl3',properties={"user": "root", "password": "root"})
