...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://10.41.104.5:3306/laws_doc', table='(select id,uuid,doc_content from judgment ) tmp',column='id',lowerBound=1,upperBound=8450135,numPartitions=99,properties={"user": "root", "password": "Hhly@2018"})
