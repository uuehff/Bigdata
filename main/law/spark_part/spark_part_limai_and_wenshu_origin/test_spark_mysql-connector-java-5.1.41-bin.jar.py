...
if __name__ == "__main__":
    ...
    df2 = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc',
                               ...
                               lowerBound=1, upperBound=5000, numPartitions=5,
    ...
    # f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_zhangye_update2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_add180wan_etl02',properties={"user": "root", "password": "root"})
    sc.stop()
