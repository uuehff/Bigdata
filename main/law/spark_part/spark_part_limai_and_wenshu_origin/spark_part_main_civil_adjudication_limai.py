...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.10.22:3306/laws_doc', table='(select id,uuid,doc_content from adjudication_civil where id > 3000000 and id <= 3879069 and doc_from = "limai" ) tmp',column='id',lowerBound=3000000,upperBound=3879069,numPartitions=24,properties={"user": "tzp", "password": "123456"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_adjudication?useUnicode=true&characterEncoding=utf8', table='adjudication_civil_etl_04',properties={"user": "root", "password": "root"})
