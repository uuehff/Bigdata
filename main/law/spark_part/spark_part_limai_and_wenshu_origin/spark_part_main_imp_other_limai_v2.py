...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.10.22:3306/laws_doc', table='(select id,uuid,doc_content,caseid,title,court,lawlist,reason_type,type,judge_type from imp_other ) tmp',column='id',lowerBound=1,upperBound=4733848,numPartitions=99,properties={"user": "tzp", "password": "123456"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_imp_other?useUnicode=true&characterEncoding=utf8', table='imp_other_etl_v2',properties={"user": "weiwc", "password": "HHly2017."})
