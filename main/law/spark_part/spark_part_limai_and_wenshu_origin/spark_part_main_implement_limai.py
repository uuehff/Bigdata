...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.10.22:3306/laws_doc', table='(select id,uuid,doc_content from implement where id > 1000000  ) tmp',column='id',lowerBound=1000000,upperBound=2119611,numPartitions=24,properties={"user": "tzp", "password": "123456"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_implement?useUnicode=true&characterEncoding=utf8', table='implement_civil_etl2',properties={"user": "root", "password": "root"})
