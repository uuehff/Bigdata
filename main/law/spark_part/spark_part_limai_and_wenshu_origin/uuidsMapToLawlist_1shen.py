...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc', table='judgment_etl_lawlist',column='id',lowerBound=0,upperBound=2900000,numPartitions=24,properties={"user": "root", "password": "root"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave2:3306/law?useUnicode=true&characterEncoding=utf8', table='lawlist_uuids_1shen_all',properties={"user": "root", "password": "HHly2017."})
