...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.12.34:3306/laws_doc_adjudication', table='(select id,uuid,doc_content from adjudication_xingshi where doc_from = "limai" ) tmp',column='id',lowerBound=3030300,upperBound=3392980,numPartitions=24,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc_adjudication?useUnicode=true&characterEncoding=utf8', table='adjudication_xingshi_etl_01',properties={"user": "root", "password": "root"})
