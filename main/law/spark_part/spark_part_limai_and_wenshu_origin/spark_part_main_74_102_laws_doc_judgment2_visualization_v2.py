...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.74.102:3306/laws_doc2', table='(select id,uuid,age_year,court_cate,delay_date,duration,gender,if_accumulate,if_adult,if_delay,if_surrender,if_team,lawyer_id,nation,law_office,province,punish_cate,punish_date,punish_money,degree from judgment2_visualization_v2 ) tmp',column='id',lowerBound=1,upperBound=2630629,numPartitions=99,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_judgment?useUnicode=true&characterEncoding=utf8', table='judgment2_visualization_v2_only',properties={"user": "weiwc", "password": "HHly2017."})
