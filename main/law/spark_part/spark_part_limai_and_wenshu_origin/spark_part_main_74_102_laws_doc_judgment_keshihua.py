...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.74.102:3306/laws_doc', table='(select id,uuid,province,city,if_surrender,if_nosuccess,if_guity,if_accumulate,if_right,if_team,if_adult,age_year,org_plaintiff,org_defendant,dispute,court_cate,if_delay,age_min,duration,history,history_title,judge,plaintiff_id,defendant_id,lawyer_id,lawyer from judgment_main_etl ) tmp',column='id',lowerBound=1,upperBound=2630629,numPartitions=99,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    def doc_items(items):
        ...
        return (items[0],uuid,items[2],items[3],items[4],
                ...
                items[21],items[22],items[23],items[24],items[25])
    ...
    schema = StructType([StructField("id", IntegerType(), False)
                            ...
                            , StructField("age_min", StringType(), True)
    ...
    f.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_judgment?useUnicode=true&characterEncoding=utf8', table='judgment_keshihua_only',properties={"user": "weiwc", "password": "HHly2017."})
