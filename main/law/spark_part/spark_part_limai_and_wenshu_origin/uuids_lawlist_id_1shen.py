...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave2:3306/law', table='uuids_lawlist_id_1shen',column='id',lowerBound=0,upperBound=200,numPartitions=20,properties={"user": "root", "password": "HHly2017."})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave2:3306/law?useUnicode=true&characterEncoding=utf8', table='uuid_and_lawlist_ids_1shen_result',properties={"user": "root", "password": "HHly2017."})
