...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://192.168.74.100:3306/wenshu_gov', table='(select id,uuid,doc_content,title,reason_type,caseid,province,court,type,casedate from judgment_500w where id >= 3500000) tmp',column='id',lowerBound=3500000,upperBound=21887040,numPartitions=99,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f1.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_civil_v5_result',properties={"user": "weiwc", "password": "HHly2017."})

    f2 = sqlContext.createDataFrame(lawyer_k_v_xingshi, schema=schema)
    f2.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_xingshi_v5_result',properties={"user": "weiwc", "password": "HHly2017."})

    f3 = sqlContext.createDataFrame(lawyer_k_v_xingzheng, schema=schema)
    f3.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_xingzheng_v5_result',properties={"user": "weiwc", "password": "HHly2017."})

    f4 = sqlContext.createDataFrame(lawyer_k_v_zhixing, schema=schema)
    f4.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8', table='judgment_zhangye_zhixing_v5_result',properties={"user": "weiwc", "password": "HHly2017."})
    ...
    f5_invalid.write.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_zhangye_v2?useUnicode=true&characterEncoding=utf8',
                  table='result_invalid_2018_10_25', properties={"user": "weiwc", "password": "HHly2017."})
