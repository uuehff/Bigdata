...
if __name__ == "__main__":
    ...
    df = sqlContext.read.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc', table='(select * from lawyer_info_add03 ) tmp2',column='id',lowerBound=0,upperBound=2800000,numPartitions=10,properties={"user": "root", "password": "root"})
    ...
    f.write.jdbc(url='jdbc:mysql://cdh-slave1:3306/laws_doc?useUnicode=true&characterEncoding=utf8', table='lawyer_info_add04',properties={"user": "root", "password": "root"})
