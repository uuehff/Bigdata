...
if __name__ == "__main__":
    ...
    lawyers = sqlContext.read.jdbc(url='jdbc:mysql://cdh5-slave2:3306/laws_doc_lawyers_new', table='(select * from hht_lawyer_all_collect_match_result_pra_number_part_group ) tmp2',column='id',lowerBound=1,upperBound=386161,numPartitions=6,properties={"user": "weiwc", "password": "HHly2017."})
    ...
    def get_results(x):
        ...
        return (i.id,i.name,i.pra_number,i.org_name,i.area,i.birth_date,i.biyexueyuan,i.city,i.edu_origin,i.first_pra_time,
                i.gender,i.id_num,i.mail,i.nation,i.org_identity,i.phone,i.politics,i.practicestatus,i.pra_course,i.pra_type,
    ...
    def get_kv(x):
        ...
        k1 = pra_number[:1] + pra_number[5:9] + pra_number[10:17]
        k2 = x.name
        k = k1 + k2
        return (k,x)
